...
def special(char_name: str, char_class: str) -> str:
    """Тренировка специального умения персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Описание выбранного класса персонажа, предложение о тренировке."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Предложение выбора класса персонажа."""
    approve_choice: str = ''
    char_class: str = ''
